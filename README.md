...
```bash
docker login
docker tag infraedge-wikipedia shlomi10/infraedge-wikipedia:latest
docker push shlomi10/infraedge-wikipedia:latest
```

Pull and run from Docker Hub:

```bash
docker pull shlomi10/infraedge-wikipedia:latest
docker run --rm -p 8501:8501 shlomi10/infraedge-wikipedia:latest
```
